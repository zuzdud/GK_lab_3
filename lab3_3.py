...
def drawJajo():
    for i in range(0, N):
        for j in range(0, N):
            ...
            glColor3f(matrixColors[i][j][0], matrixColors[i][j][1], matrixColors[i][j][2])
            glVertex3f(matrix[i][j][0], matrix[i][j][1], matrix[i][j][2])

            
            glColor3f(matrixColors[i+1][j][0], matrixColors[i+1][j][1], matrixColors[i+1][j][2])
            glVertex3f(matrix[i+1][j][0], matrix[i+1][j][1], matrix[i+1][j][2])

            glColor3f(matrixColors[i][j+1][0], matrixColors[i][j+1][1], matrixColors[i][j+1][2])
            glVertex3f(matrix[i][j+1][0], matrix[i][j+1][1], matrix[i][j+1][2])

            glColor3f(matrixColors[i+1][j+1][0], matrixColors[i+1][j+1][1], matrixColors[i+1][j+1][2])
